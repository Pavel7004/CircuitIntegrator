...
func BenchmarkBogatskiyShampin(b *testing.B) {
	int := bogatskiyshampin.NewShampinInt(0, 60, 0.0001, func(t float64, x *circuit.Circuit) error {
		return nil
	})
